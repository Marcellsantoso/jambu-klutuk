...
public class ArtbookPlayer {
	...
	public ArtbookPlayer withId(Integer id) {
		this.id = id;
		return this;
	}
	...
	public ArtbookPlayer withName(String name) {
		this.name = name;
		return this;
	}
	...
	public ArtbookPlayer withLocation(String location) {
		this.location = location;
		return this;
	}
	...
	public ArtbookPlayer withFollowers_count(Integer followers_count) {
		this.followers_count = followers_count;
		return this;
	}
	...
	public ArtbookPlayer withDraftees_count(Integer draftees_count) {
		this.draftees_count = draftees_count;
		return this;
	}
	...
	public ArtbookPlayer withLikes_count(Integer likes_count) {
		this.likes_count = likes_count;
		return this;
	}
	...
	public ArtbookPlayer withLikes_received_count(Integer likes_received_count) {
		this.likes_received_count = likes_received_count;
		return this;
	}
	...
	public ArtbookPlayer withComments_count(Integer comments_count) {
		this.comments_count = comments_count;
		return this;
	}
	...
	public ArtbookPlayer withComments_received_count(Integer comments_received_count) {
		this.comments_received_count = comments_received_count;
		return this;
	}
	...
	public ArtbookPlayer withRebounds_count(Integer rebounds_count) {
		this.rebounds_count = rebounds_count;
		return this;
	}
	...
	public ArtbookPlayer withRebounds_received_count(Integer rebounds_received_count) {
		this.rebounds_received_count = rebounds_received_count;
		return this;
	}
	...
	public ArtbookPlayer withUrl(String url) {
		this.url = url;
		return this;
	}
	...
	public ArtbookPlayer withAvatar_url(String avatar_url) {
		this.avatar_url = avatar_url;
		return this;
	}
	...
	public ArtbookPlayer withUsername(String username) {
		this.username = username;
		return this;
	}
	...
	public ArtbookPlayer withTwitter_screen_name(String twitter_screen_name) {
		this.twitter_screen_name = twitter_screen_name;
		return this;
	}
	...
	public ArtbookPlayer withWebsite_url(String website_url) {
		this.website_url = website_url;
		return this;
	}
	...
	public ArtbookPlayer withDrafted_by_player_id(Integer drafted_by_player_id) {
		this.drafted_by_player_id = drafted_by_player_id;
		return this;
	}
	...
	public ArtbookPlayer withShots_count(Integer shots_count) {
		this.shots_count = shots_count;
		return this;
	}
	...
	public ArtbookPlayer withFollowing_count(Integer following_count) {
		this.following_count = following_count;
		return this;
	}
	...
	public ArtbookPlayer withCreated_at(String created_at) {
		this.created_at = created_at;
		return this;
	}
